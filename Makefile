...
AWS_RDS_IAC_MODULE_DIR ?= infra/aws/modules/rds-postgresql
AWS_EKS_IAC_MODULE_DIR ?= infra/aws/modules/eks
AWS_ALB_IAC_MODULE_DIR ?= infra/aws/modules/alb
...
iac-aws-validate:
	...
	tofu -chdir=$(AWS_RDS_IAC_MODULE_DIR) init -backend=false
	tofu -chdir=$(AWS_RDS_IAC_MODULE_DIR) validate
	tofu -chdir=$(AWS_EKS_IAC_MODULE_DIR) init -backend=false
	tofu -chdir=$(AWS_EKS_IAC_MODULE_DIR) validate
	tofu -chdir=$(AWS_ALB_IAC_MODULE_DIR) init -backend=false
	tofu -chdir=$(AWS_ALB_IAC_MODULE_DIR) validate
