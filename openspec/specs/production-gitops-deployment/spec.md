# Production GitOps Deployment Specification

## Purpose

Define the source-controlled AWS GitOps desired state, promotion, validation,
and operations expectations for the FlagForge API Level 3 `dev` target.
