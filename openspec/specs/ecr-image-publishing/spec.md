...
Define the AWS ECR image publishing contract, trust boundaries, tagging strategy, vulnerability gate, retention expectations, and deployment handoff for FlagForge API container images.
