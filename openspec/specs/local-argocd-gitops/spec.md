...
Define the local-only GitOps desired state, workflow, validation, and operations expectations for running FlagForge through Argo CD in a local Kubernetes environment.
