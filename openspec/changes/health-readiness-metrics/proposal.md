...
- Documentation impact: update README or the local development runbook with operational endpoint verification steps, including `/metrics`.
- Test impact: add Supertest and focused unit coverage for liveness, successful readiness, failing readiness, metrics exposure, and regression coverage for the unchanged `/health` behavior.
