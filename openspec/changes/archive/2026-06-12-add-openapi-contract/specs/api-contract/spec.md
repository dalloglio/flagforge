...
The OpenAPI contract SHALL document the current public HTTP endpoints without adding, removing, or changing endpoint behavior.
...
The OpenAPI contract SHALL document known successful and client error status codes for the current API.
